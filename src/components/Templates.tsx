...
const categories = [
  "Tất cả", "Nhà hàng", "Du lịch", "Giáo dục", "Doanh nghiệp", "E-commerce", "Giải trí", "Thư viện ảnh"
];
    ...
    <section className="bg-gray-50 py-20" id="templates">
      <div className="section-container">
        <div className="flex justify-between items-end mb-12">
          <div>
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Giao diện mẫu</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredTemplates.map((template, index) => (
            <a href={template.link} key={index} target="_blank" rel="noopener noreferrer" className="bg-white rounded-lg overflow-hidden hover:scale-[1.02] transition-transform duration-300">
              ...
              <div className="p-4">
                ...
                <h3 className="text-xl font-medium mt-1">{template.name}</h3>
              </div>
            </a>
          ))}
        </div>
